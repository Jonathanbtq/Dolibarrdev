...
/**
 * \file    core/triggers/interface_99_modFastmodulecheck_FastmodulecheckTriggers.class.php
 ...
 *      - interface_99_modFastmodulecheck_MyTrigger.class.php
...
/**
 *  Class of triggers for Fastmodulecheck module
 */
class InterfaceFastmodulecheckTriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "Fastmodulecheck triggers.";
		$this->version = self::VERSIONS['dev'];
		$this->picto = 'fastmodulecheck@fastmodulecheck';
	}
